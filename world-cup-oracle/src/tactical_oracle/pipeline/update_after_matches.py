...
from tactical_oracle.pipeline.match_performance import write_real_match_performance_outputs
from tactical_oracle.pipeline.real_outputs import write_post_group_match_probability_outputs
from tactical_oracle.pipeline.tournament_projection import write_tournament_projection_outputs
from tactical_oracle.pipeline.validation_report import build_worldcup_validation_report
from tactical_oracle.pipeline.worldcup_detail import write_worldcup_detail_outputs


def _schedule_file_for_post_group_step(schedule_path: str | Path, interim_dir: str | Path) -> str | Path:
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Run the local after-match update pipeline without spending API calls by default."
    )
